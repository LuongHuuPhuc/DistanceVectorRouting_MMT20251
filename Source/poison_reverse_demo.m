...
% Vong lap ma link bi failure (Khi nao mang bi link failure)
LINK_FAILURE_ITER = 473;
...
for iter = 1 : MAX_ITER
    ...
    x_update = mod(iter - 1, N) + 1;
    [DV_new, NextHop] = distance_vector_step_for_demo(...
        DV, cost, NextHop, ...
        USE_SPLIT_HORIZION, ...
    ...
    % Chi luu tong cost dinh tuyen cua Router 1 va Router 3
    % De bieu thi Count-to-Infinity ro hon
